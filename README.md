...
The data I will use to construct phylogenies will come from a 2016 study of metastatic lineages (Zhao et al., 2016), which performed sequencing on normal tissue, primary tissue, and several metastatic sites for several patients of different cancers. For some patients, the primary tumor was resected and sequenced earlier than the metastatic sites, allowing for time-calibration. The met
